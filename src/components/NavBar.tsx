...
function NavBar() {
  ...
  return (
    <nav className="w-full h-24 fixed z-50 bg-neutral-950 bg-opacity-50 border-b border-black backdrop-blur-sm top-0 p-4 px-6 flex items-center justify-between scrollbar-hide">
      <ul className="flex flex-row items-center text-white text-nowrap">
        ...
        <li className="cursor-pointer hover:text-red-600 hover:scale-110 transition-all duration-100 hidden lg:flex px-2">Movies</li>
