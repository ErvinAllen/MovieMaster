...
const searchInput = (
    <label className="input input-bordered flex items-center gap-2 bg-transparent mx-2 w-48">
  ...
  return (
    <nav className="w-full h-24 fixed z-50 bg-neutral-950 bg-opacity-50 backdrop-blur-sm top-0 p-4 px-4 flex items-center justify-between scrollbar-hide">
      <ul className="flex flex-row items-center text-white text-nowrap">
        <li><img src="/src/assets/logo.png" alt="Logo" className="mr-8" width={64} height={64} /></li>
        <Link to={'/'} className="cursor-pointer hover:text-red-600 hover:scale-110 transition-all duration-100 hidden lg:flex px-2">Home</Link>
        <li className="cursor-pointer hover:text-red-600 hover:scale-110 transition-all duration-100 hidden lg:flex px-2">TV Shows</li>
        <Link to={'/discoverMore'} className="cursor-pointer hover:text-red-600 hover:scale-110 transition-all duration-100 hidden lg:flex px-2">Movies</Link>
        <li className="cursor-pointer hover:text-red-600 hover:scale-110 transition-all duration-100 hidden lg:flex px-2">News & Popular</li>
        <li className="cursor-pointer hover:text-red-600 hover:scale-110 transition-all duration-100 hidden lg:flex px-2">My List</li>
        <li className="cursor-pointer hover:text-red-600 hover:scale-110 transition-all duration-100 hidden lg:flex px-2">Languages</li>
      </ul>
